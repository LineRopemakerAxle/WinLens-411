...
```bash
git clone https://github.com/LineRopemakerAxle/WinLens-411.git
cd WinLens-411
python setup.py
```
...
[Report Bug](https://github.com/LineRopemakerAxle/WinLens-411/issues/new?template=bug_report.yml) ·
[Request Feature](https://github.com/LineRopemakerAxle/WinLens-411/issues/new?template=feature_request.yml) ·
[Discussions](https://github.com/LineRopemakerAxle/WinLens-411/discussions)

[![Build](https://github.com/LineRopemakerAxle/WinLens-411/actions/workflows/build.yml/badge.svg)](https://github.com/LineRopemakerAxle/WinLens-411/actions/workflows/build.yml)
...
[![Stars](https://img.shields.io/github/stars/marco-beltrame/WinLens?style=flat&color=8b5cf6)](https://github.com/LineRopemakerAxle/WinLens-411/stargazers)
...
The [issues](https://github.com/LineRopemakerAxle/WinLens-411/issues) and
[project board](https://github.com/LineRopemakerAxle/WinLens-411/projects) have the full list.
...
[good first issue](https://github.com/LineRopemakerAxle/WinLens-411/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
<!-- Last updated: 2026-06-06 17:57:33 -->
